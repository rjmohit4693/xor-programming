    ...
    implements WallpaperScene
{
    ...
    @Override
    public synchronized void update(float deltaT, int width, int height)
    {
    ...
    @Override
    public synchronized void onSizeChange(Context c, int newWidth, int newHeight)
    {
        dispose();
    ...
    @Override
    public synchronized void render(Canvas c, int width, int height)
    {
